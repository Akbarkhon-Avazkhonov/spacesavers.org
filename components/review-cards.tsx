...
const reviews = [
  {
    ...
    pros: ["Intelligent heat control", "5 magnetic styling attachments", "Very fast drying"],
    cons: ["Premium price tag", "Cord is not removable"],
    verdict: "Best if you want maximum hair protection and salon-level results at home.",
  ...
  },
  {
    ...
    pros: ["5‑in‑1 styler and dryer", "Auto-wrap curlers for easy curls", "Works for most hair types"],
    cons: ["Small learning curve for styling", "Can feel a bit heavy during long sessions"],
    verdict: "Great if you want an Airwrap-style alternative with auto-wrap curls at a more accessible price.",
    badge: "Best Value",
  ...
  {
    id: 3,
    slug: "/hair-tech/panasonic-quickdry-oscillating",
    ...
    pros: ["QuickDry oscillating nozzle", "Even airflow distribution", "Solid option for daily drying"],
    cons: ["Not as powerful as premium dryers", "Attachments are more basic"],
    verdict: "Best if you want a comfortable everyday dryer without paying flagship prices.",
    badge: "Budget Pick",
